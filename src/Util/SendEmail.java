...
public class SendEmail {
    ...
    public static String myEmailAccount = "1427446317@qq.com";
    public static String myEmailPassword = "nibwxgyyvynrgjeb";
